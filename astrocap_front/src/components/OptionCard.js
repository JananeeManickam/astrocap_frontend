                ...
                <div className="content">
                    <div className="back">
                        <div className="back-content">
                            ...
                            <img src={object.url} alt={object.name} width="90" height="90" />
                    ...
                    <div className="front">
                        ...
                        <div className="front-content">
                            <small className="badge" style={{ fontSize: '20px' }}>{object.type}</small>
                            ...
                            <div className="description">
                                ...
                                {object.path ? (
                                    <Link 
                                        to={object.path || `/planets/${object.name.toLowerCase()}`} 
                                        className="explore-link"
                                    >
                                        Explore
                                    </Link>
                                ) : (
                                    <span className="explore-link disabled">Coming Soon</span>
                                )}
                                </div>
                            </div>
                        </div>
